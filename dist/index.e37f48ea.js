...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        (0, _addRecipeViewJsDefault.default).sucessMessage();
        // render recipe
        (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe);
...
},{"./view/recipeView.js":"7Olh7","./view/searchView.js":"blwqv","./view/resultsView.js":"46Nfk","./model.js":"Y4A21","./view/paginationView":"9Reww","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./view/bookmarksView.js":"uOrlR","./view/addRecipeView.js":"bxpSm","./config":"k5Hzs"}],"7Olh7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class RecipeViews extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = `We couldnt fint that recipe. Please try again`;
    _sucsessMessage;
  ...
  ${this._data.ingredients.map(this._generateIngridents).join("")}
  </ul>
</div>
...
`;
    ...
    addHandlerRender(handlerSubscriber) {
        [
            "hashchange",
            "load"
        ].forEach((ev)=>window.addEventListener(ev, handlerSubscriber));
    }
...
},{"./View.js":"gAkKI","url:../../img/icons.svg":"loVOp","fracty":"hJO4d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gAkKI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class View {
    ...
    sucessMessage(message = this._sucessMessage) {
        const markup = `
          <div class="message">
            <div>
              <svg>
...
},{"./View.js":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"46Nfk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"gAkKI","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./previewView.js":"8eAfY"}],"8eAfY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class PreviewVeiw extends (0, _viewJsDefault.default) {
    _parentElement = "";
    _generateMarkup() {
        const id = window.location.hash.slice(1);
        return `
...
exports.default = new PreviewVeiw(); /*
{
  "id": "5ed6604591c37cdc054bcd09",
  "title": "Cauliflower Pizza Crust (with BBQ Chicken Pizza)",
  "publisher": "Closet Cooking",
...
},{"./View.js":"gAkKI","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./config":"k5Hzs","./helper":"lVRAz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view/addRecipeView":"bxpSm"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const API_KEY = "b3c6dadd-4461-4799-92ac-41e1bfa76244";
...
const AJAX = async function(url, uploadData) {
 ...
 //   } catch (error) {
 //     throw error;
 //     // too pass the error to the other function which you dont want to handle that error here so you can throw the error in the catch block and it will be sent to the other function which called that function
 //   }
 // };
...
},{"./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bxpSm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) return this._paginationBtns("next", curPage);
        // last page
        if (curPage === numPages && numPages > 1) return this._paginationBtns("prev", curPage);
        // other page
        if (curPage < numPages) return `${this._paginationBtns("prev", curPage)} ${this._paginationBtns("next", curPage)}`;
    ...
    _paginationBtns(type, curPage) {
        ...
        return `
          ...
          ${type === "prev" ? `<svg class="search__icon">
                ...
                <span>Page ${curPage}</span>` : `<span>Page ${curPage}</span>
                  <svg class="search__icon">
                  <use href="${0, _iconsSvgDefault.default}#icon-arrow-right"></use>
                </svg>`}
        </button>`;
...
},{"./View.js":"gAkKI","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
},{"./View.js":"gAkKI","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./previewView.js":"8eAfY"}]},["aD7Zm","aenu9"], "aenu9", "parcelRequire3a11")
